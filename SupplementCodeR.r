...
MomentsBates = function(mu, kappa, theta, sigma, rho, lambda, muj, vj, t){
...
# Compute first 4 conditional moments of v_t
MomentsCIR(p = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250)

# Compute first 4 unconditional moments v_t
MomentsCIR(p = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250, conditional = F)

# Compute all combination of (p,q)-th conditonal comoment v_t
MomentsCIR(p = 1:4, q = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250, comoments = T)

# Compute all combination of (p,q)-th unconditonal comoment v_t
MomentsCIR(p = 1:4, q = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250, conditional = F, comoments = T)

# Compute first four unconditonal moments as well as skewness and kurtosis for t-year log-returns
MomentsBates(mu = 0, kappa = 3, theta = 0.19, sigma = 0.4, rho = -0.7, lambda = 20, muj = 0, vj = 0.1, t = 1/250)
